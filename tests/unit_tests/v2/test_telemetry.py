...
from luthien_proxy.v2 import telemetry
...
class TestSetupTelemetry:
    ...
    @patch("luthien_proxy.v2.telemetry.configure_tracing")
    @patch("luthien_proxy.v2.telemetry.configure_logging")
    @patch("luthien_proxy.v2.telemetry.instrument_redis")
    @patch("luthien_proxy.v2.telemetry.instrument_app")
