...
See: [tests/luthien_proxy/integration_tests/v2/test_routes.py](../../integration_tests/v2/test_routes.py)
...
- `tests/luthien_proxy/unit_tests/v2/test_routes_helpers.py`

Follow guidelines in [tests/luthien_proxy/unit_tests/CLAUDE.md](../CLAUDE.md)
