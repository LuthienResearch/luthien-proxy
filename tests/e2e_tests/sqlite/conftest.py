...
def sqlite_gateway_url():
    ...
    import tests.e2e_tests.conftest as parent
    ...
    import tests.e2e_tests.test_mock_request_forwarding as m_fwd
    import tests.e2e_tests.test_mock_session_history as m_sessions
