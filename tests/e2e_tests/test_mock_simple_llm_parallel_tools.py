...
Run:
    ...
    uv run pytest -m mock_e2e tests/e2e_tests/test_mock_simple_llm_parallel_tools.py -v
"""

import pytest
from tests.e2e_tests.conftest import API_KEY, GATEWAY_URL, policy_context
from tests.e2e_tests.mock_anthropic.responses import parallel_tool_response, text_response
