...
- [ ] Implement parallel LLM call orchestration (ParallelRulesPolicy was removed; needs reimplementation)
...
- [ ] Design reviewer decision schema (ParallelRulesPolicy was removed; needs reimplementation)
