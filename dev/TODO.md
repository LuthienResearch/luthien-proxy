...
### Dogfooding Safety (COE from 2026-02-25 incident, PR #238)
...
- [x] **Document dogfooding safety protocol** — Until system policy exists: never run Docker/infra commands from a proxied session. Added warning to quick_start.sh output. (Done: PR #238)
