...
- [ ] **Retrospective on dogfooding sessions** - Review session CSVs in `~/dev/luthien-session-logs/` and document learnings. What worked? What was painful? What should we build next? **Deadline: Dec 23, 2025**. Files: `scott_image_repro_clean.csv`, `conversation_2025-12-16_*.csv`.
