...
- [kill-conversation-logging-policy](kill-conversation-logging-policy): Removed ConversationLoggingPolicy - core hooks infrastructure already captures original→final versions in conversation_events and debug_logs, making the redundant policy unnecessary.
