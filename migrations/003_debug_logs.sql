-- ABOUTME: Creates debug_logs table for arbitrary structured debugging info
...
GRANT ALL PRIVILEGES ON debug_logs TO luthien;
GRANT ALL PRIVILEGES ON debug_logs TO litellm;
