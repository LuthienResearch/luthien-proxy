...
Reads every JSON file in tests/e2e_tests/failure_registry/ and emits a
...
Workflow:
    1. Run real-API tests:
           uv run pytest -m e2e tests/e2e_tests/test_real_api_threat_scenarios.py -v
    2. Inspect captures:
           ls tests/e2e_tests/failure_registry/
    3. Generate mock tests:
           uv run python scripts/generate_mock_from_failures.py
    4. Run generated tests:
           uv run pytest -m mock_e2e tests/e2e_tests/test_mock_from_failures.py -v
"""
