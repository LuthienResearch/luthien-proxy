...
<img src="assets/readme/terminal-without-luthien.svg?v=2" alt="Without Luthien: Claude Code runs pip install despite CLAUDE.md rules" width="100%">

</td>
<td width="50%">

<img src="assets/readme/terminal-with-luthien.svg?v=2" alt="With Luthien: pip install is blocked, Claude retries with uv add" width="100%">
