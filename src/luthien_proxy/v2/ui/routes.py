...
"""UI routes for V2 gateway activity monitoring and debugging."""
...
from luthien_proxy.v2.observability import stream_activity_events

router = APIRouter(prefix="/v2", tags=["ui"])
