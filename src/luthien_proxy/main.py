...
# ---------------------------------------------------------------------------
# Sentry scrubbing functions (always defined so tests can import them)
# ---------------------------------------------------------------------------
_LLM_CONTENT_VARS = {
    "body",
    "messages",
...
# ---------------------------------------------------------------------------
# Sentry SDK initialization (opt-out: set SENTRY_ENABLED=false)
# ---------------------------------------------------------------------------
...
if _sentry_settings.sentry_enabled and _sentry_settings.sentry_dsn:
    ...
    sentry_sdk.init(
        ...
        release=f"{_sentry_settings.service_name}@{_sentry_settings.service_version}",
        server_name=_sentry_settings.sentry_server_name or None,
