...
# Patterns that match commands which could kill or corrupt the proxy.
# Tested against: docker compose down, docker stop, pkill uvicorn, rm -rf src/, etc.
# Safe commands like docker compose logs, docker ps, git status pass through.
...
class DogfoodSafetyPolicy(BasePolicy, OpenAIPolicyInterface, AnthropicPolicyInterface):
    ...
    async def on_finish_reason(self, ctx: "StreamingPolicyContext") -> None:
        """No-op — finish reason handled in on_stream_complete."""
