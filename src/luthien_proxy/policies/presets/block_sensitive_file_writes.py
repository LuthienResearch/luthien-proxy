...
from luthien_proxy.policy_core import CatalogBadge, Category, UIMetadata
...
class BlockSensitiveFileWritesPolicy(SimpleLLMPolicy):
    ...
    # NOTE: ui_policy_preview is a UI hint only. The actual runtime block
    # message is generated by the judge LLM (see SimpleLLMPolicy judge prompt
    # in __init__) and may differ in wording.
    ui = UIMetadata(
