...
Luthien is a proxy that sits between Claude Code (or Codex) and the LLM. It intercepts every request and response, letting you enforce rules, block dangerous operations, and clean up output — without changing your dev setup.
